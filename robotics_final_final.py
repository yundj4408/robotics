...
Adafruit_IO_KEY = '"aio_CtSP59bRSm8iSVgeeUe4Na0bPBus"'
...
for i in range(0, 25): #노드 개수로 바꾸기
        ...
        for firesensor, smokesensor in zip(firekey, smokekey) :
            ...
            if fire_value >= 65 : # 불이 났을 때 -> 1말고 
                ...
                if node_num not in knu.firesensor_value:
                    ...
                    aio.send_data(led12.key, knu.node[12].exit_diret)
                    print("knu.node num is")
                    print(knu.node[12].exit_diret)
                    aio.send_data(led13.key, knu.node[13].exit_diret)
                    print("knu.node num is")
                    print(knu.node[13].exit_diret)
                    aio.send_data(led14.key, knu.node[14].exit_diret)
                    print("knu.node num is")
                    print(knu.node[14].exit_diret)
                    aio.send_data(led15.key, knu.node[15].exit_diret)
                    print("knu.node num is")
                    print(knu.node[15].exit_diret)
                    aio.send_data(led16.key, knu.node[16].exit_diret)
                    print("knu.node num is")
                    print(knu.node[16].exit_diret)
                    aio.send_data(led17.key, knu.node[17].exit_diret)
                    print("knu.node num is")
                    print(knu.node[17].exit_diret)
                    aio.send_data(led18.key, knu.node[18].exit_diret)
                    print("knu.node num is")
                    print(knu.node[18].exit_diret)
                    aio.send_data(led19.key, knu.node[19].exit_diret)
                    print("knu.node num is")
                    print(knu.node[19].exit_diret)
                    aio.send_data(led20.key, knu.node[20].exit_diret)
                    print("knu.node num is")
                    print(knu.node[20].exit_diret)
                    aio.send_data(led21.key, knu.node[21].exit_diret)
                    print("knu.node num is")
                    print(knu.node[21].exit_diret)
                    aio.send_data(led22.key, knu.node[22].exit_diret)
                    print("knu.node num is")
                    print(knu.node[22].exit_diret)
                    aio.send_data(led23.key, knu.node[23].exit_diret)
                    print("knu.node num is")
                    print(knu.node[23].exit_diret)
                    aio.send_data(led24.key, knu.node[24].exit_diret)
                    print("knu.node num is")
                    print(knu.node[24].exit_diret)

                    '''
                    #결과값 출력하는 구문
                    #print("fire in", node_num)
                    for i in range(25):
                      led_name = 'led{0:>02d}.key'.format(i)
                      aio.send_data(led_name, knu.node[i].exit_diret)
                      print("knu.node num is")
